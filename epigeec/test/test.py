...
def launch_filter(
    hdf5_path, chrom_path, filtered_path, include_path=None, exclude_path=None
):
...
class EpigeecTest(unittest.TestCase):
    ...
    def test_e2e_nm(self):
        self.e2e()
        sig_path = [
            os.path.join(self.sig_dir, "d9f18e91644bacfee3669d577b661d15"),
            os.path.join(self.sig_dir, "fd85fe6672c629a116a9b6131883a60b"),
            os.path.join(self.sig_dir, "70ac0e9e6b4dbdf5d6b5cbf54a8989e3"),
        ]
        hdf5_path1 = [
            os.path.join(self.hdf5_dir, "d9f18e91644bacfee3669d577b661d15"),
        ...
        with open(self.list_path, "w", encoding="utf8") as test_list:
        ...
        with (
            open(result, "r", encoding="utf8") as res_file,
            open(expected, "r", encoding="utf8") as exp_file,
        ):
            self.assertEqual(res_file.read(), exp_file.read())
    ...
    def test_e2e_hg19(self):
        self.e2e()
        sig_path = [
            os.path.join(self.sig_dir, "001f63cdf00286183e32c1bb0fd6d85f"),
            os.path.join(self.sig_dir, "002f4247fadb6c6e4000a6fc12e5b93a"),
        ]
        hdf5_path = [
            os.path.join(self.hdf5_dir, "001f63cdf00286183e32c1bb0fd6d85f"),
    ...
    def test_e2e_saccer(self):
        ...
        filtered_path = [
            os.path.join(self.filtered_dir, "d9f18e91644bacfee3669d577b661d15"),
...
def main():
    ...
    parser.add_argument(
        "-v", "--verbose", help="enable debug logs", action="store_true"
    )
    ...
    py_dir = os.path.join(
        os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "python", "core"
    )
