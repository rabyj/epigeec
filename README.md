...
Conversion of a signal file to the hdf5 format
	...
	usage: epigeec to_hdf5 [-h] (-bw | -bg) signal_file chrom_sizes resolution out_hdf5

Filter an hdf5 file (optional)  

	usage: epigeec filter [-h] [--select SELECT] [--exclude EXCLUDE] hdf5 chrom_sizes resolution out_hdf5

Generate an NxN Pearson correlation matrix  

	usage: epigeec correlate [-h] hdf5_list chrom_sizes resolution out_matrix 
